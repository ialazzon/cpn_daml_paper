 ...
 * <!-- end-user-doc -->
 * @see daml.DamlPackage
 * @generated
 */
public class DamlSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DamlPackage modelPackage;
	...
	public DamlSwitch() {
		if (modelPackage == null) {
			modelPackage = DamlPackage.eINSTANCE;
		}
	}
